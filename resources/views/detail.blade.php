    ...
    <div class="page-content page-details">
        ...
        <div class="store-details-container" data-aos="fade-up">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="owner">by wahyu purnama</div>
                            <div class="price">$1.00</div>
                        </div>
                        <div class="col-lg-2" data-aos="zoom-in">
                            <a href="/cart.html" class="btn btn-success px-4 text-white btn-block mb-3">Whatsapp</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <p> The Nike Air Max 720 SE goes bigger than ever before with Nike's tallest Air unit yet
                                for unimaginable, all-day comfort. There's super breathable fabrics on the upper, while
                                colours add a modern edge.
                            </p>
                            <p>
                                Bring the past into the future with the Nike Air Max 2090, a bold look inspired by the
            ...
            {{-- <section class="store-review">
                <div class="container">
                    <div class="row">
                        <div class="col-12 cool-lg-8 mt-3 mb-3">
        ...
        var gallery = new Vue({
            ...
            data: {
                ...
                photos: [{
                    ...
                    {
                        id: 2,
                        url: "{{ url('images/banner-2.jpg') }}",
                    },
                    {
                        id: 3,
                        url: "{{ url('images/banner-3.jpg') }}",
                    },
                    {
                        id: 4,
                        url: "{{ url('images/banner-3.jpg') }}",
